...
import LightboxComponent from './OtherComponents/LightboxComponent.jsx'
          ...
          >
            <div style={{marginLeft:"12px"}}>
              ...
              <ul style={{listStyleType:"none"}}>
                <li>Boss Name: <b>{props.boss[0]}</b></li>
                <li>What is his / her current evaluation: <b>{props.boss[1]}</b></li>
              </ul>
              {console.log(props.cost)}
              <h4>Cost of Living info: (These indices are relative to New York City: 100)</h4> 
              {props.cost === undefined ? <p>Information not available</p> : 
              <ul style={{listStyleType:"none"}}>
                <li>The Cost of living Index of {props.nameOfCity} is: <b>{props.cost.costOfLivingIndex}</b></li>
                <li>The Rent Index of {props.nameOfCity} is <b>{props.cost.rentIndex}</b></li>
                <li>The Groceries Index of {props.nameOfCity} is : <b>{props.cost.groceriesIndex}</b></li>
                <li>The Restaurant Price Index of {props.nameOfCity} is <b>{props.cost.restaurantPriceIndex}</b></li>
