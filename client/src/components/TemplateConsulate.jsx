...
export default class TemplateConsulate extends Component {
  ...
  constructor(props) {
        ...
        this.classP = this.props.classP;
        this.nameOfCity = this.props.name;
        this.boss = this.props.boss;
  ...
  render() {
    return (
      <Modal trigger={<ConsulateImg classP={this.classP} nameOfCity={this.nameOfCity} boss={this.boss}/>}closeIcon>
      ...
      <Modal.Content image>
        ...
        />
        <Modal.Description>
          <Header>Consulate General of Brazil in {this.nameOfCity}</Header>
